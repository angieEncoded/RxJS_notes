...
const observable = fromEvent(
    ...
    // This will not allow requests to overlap, it will close the previous one
    // Go to the network tab and select Throttling slow 3g to simulate a slow internet connection
    // Then you will see the requests getting cancelled
    switchMap(() => {
